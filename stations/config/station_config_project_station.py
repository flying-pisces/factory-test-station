...
CSV_SUMMARY_DIR = os.path.join(os.path.dirname(ROOT_DIR), 'log', 'factory-test_logs', 'project_summary')
RAW_DIR = os.path.join(os.path.dirname(ROOT_DIR), 'log', 'raw_logs')
##################################
# serial number codes
#
...
SW_TITLE = 'Factory Test Station'
SHOW_CONSOLE = False
IS_PRINT_TO_LOG = True
IS_LOG_PROFILING = False
...
#
MIN_SPACE_REQUIRED = [
    [ROOT_DIR, 1000]  # 1GB minimum space required
]